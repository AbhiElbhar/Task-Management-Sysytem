...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row mt-3">
            <div class="col-sm-4">
                <a href="{{ url('create-task') }}" class="btn btn-danger rounded-pill mb-3"><i class="mdi mdi-plus"></i>Add
                    New Task</a>
            </div>
        </div>       
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="mb-3 mt-0 pt-2 text-uppercase header-title">User Task</h5>
                        @if (session('success'))
